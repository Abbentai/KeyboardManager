<div class="flexcolumn center gap">
    ...
    <md-outlined-text-field label="Store Name" required name="name" id="name" value="{{ old('name', $store->name) }}"
        @error('name') error @enderror error-text="Name is required">
        <md-icon slot="leading-icon">store</md-icon>
    </md-outlined-text-field>


    <md-outlined-text-field label="Store Url" required name="url" id="url" value="{{ old('url', $store->url) }}"
